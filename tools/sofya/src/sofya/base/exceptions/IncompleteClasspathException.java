...
/**
 * Defines an exception that indicates that the classpath provided to
...
public class IncompleteClasspathException extends RuntimeException  {
    ...
    private static final long serialVersionUID = 870369088711355538L;
    ...
    /** Creates an instance with the given message wrapping another
        exception. */
    public IncompleteClasspathException(String s, Throwable cause) {
        super(s);
        this.cause = cause;
    }
