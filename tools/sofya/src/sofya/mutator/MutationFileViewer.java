...
public class MutationFileViewer {

    private static void printUsage() {
        System.err.println("Usage:\n java sofya.mutator.MutationFileViewer " +
            "MutationTableFileName"); 
        System.exit(1);
    }
    ...
    public static void main(String[] argv) throws MutationException {
        ...
        System.out.println("ID:Type:ClassName:FieldName:OrigAccFlags:dfltMutFlag:Variant;Variant;...");
        System.out.println("--------------------------------------------------------------------------------");
