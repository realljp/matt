...
/**
 * <p>A branch sequence tracer records the sequence of branch edges
...
public class BranchSequenceTracer {
    ...
    public static void main(String[] argv) {
        try {
            ProgramEventDispatcher ed =
                ProgramEventDispatcher.createBranchSequenceTracer(argv,
    ...
    private static void printUsage() {
        System.err.println("Usage:\njava sofya.ed.BranchTracer " +
            ...
            "[-o OutputFile] [-ja <arg1> .. <__end>] -<I|S|T|C|E|O>\n" +
