...
/**
 * <p>A basic block tracer collects basic block coverage information and writes
 * it as a trace file.</p>
 *
 * @author Alex Kinneer
 * @version 11/16/2006
 */
public class BBTracer {
    private BBTracer() {
    }
    ...
    public static void main(String[] argv) {
        try {
            ProgramEventDispatcher ed =
                ProgramEventDispatcher.createBlockCoverageTracer(argv,
    ...
    /*************************************************************************
     * Prints the basic block tracer usage message and exits.
     */
    private static void printUsage() {
        System.err.println("Usage:\njava sofya.ed.BBTracer [-port N] " +
            "[-cp PATH] [-i] [-tl N] [-at]\n [-trname <TraceName>] " +
